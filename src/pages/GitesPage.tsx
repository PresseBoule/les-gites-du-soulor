...
export function GitesPage() {
  ...
  return (
    <div className="pt-24 pb-16">
      <Helmet>
        <title>Gîtes 3 Personnes Pyrénées - 4 Logements Tout Confort | Les Gîtes du Soulor</title>
        <meta name="description" content="Découvrez nos 4 gîtes pour 3 personnes à Arrens-Marsous : Le Suyen, Le Tech, L'Estaing et Le Soum. Hébergements tout confort en montagne, Hautes-Pyrénées." />
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <EditableText
              ...
              value={content.pages?.gites?.sousTitre || 'Quatre havres de paix pour 3 personnes, chacun avec son caractère unique'}
              as="p"
          ...
          >
            <div className="p-8 rounded-2xl bg-gradient-to-br from-white/5 to-transparent border border-white/10">
              <EditableText
                ...
                value={content.pages?.gites?.introduction || 'Chacun de nos quatre gîtes a été pensé pour accueillir confortablement 3 personnes dans un cadre intimiste et raffiné. Que vous recherchiez une escapade romantique, un séjour ressourçant ou une base pour vos aventures en montagne, vous trouverez ici votre refuge idéal.'}
                as="p"
